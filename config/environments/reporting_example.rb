Digitalsocial::Application.configure do
  ...
  Digitalsocial::DATA_ENDPOINT = 'http://127.0.0.1:3030/digitalsocial_reporting/data'

  Tripod.configure do |config|
    config.update_endpoint = 'http://127.0.0.1:3030/digitalsocial_reporting/update'
    config.query_endpoint = 'http://127.0.0.1:3030/digitalsocial_reporting/sparql'
