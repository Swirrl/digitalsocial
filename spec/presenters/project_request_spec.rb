...
describe ProjectRequest do
  ...
  it "must have not be for an organisation already a member of the project" do
    FactoryGirl.create(:project_membership, organisation: project_request.sender.uri.to_s, project: project_request.project.uri.to_s)
  ...
  describe '.save' do
    ...
    it "must create a request with the correct details" do
      ...
      project_request.request.receiver.should == project_request.creator_organisation
