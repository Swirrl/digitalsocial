    ...
    describe '.send_request_digests' do
      ...
      context 'one organisation' do
        ...
        it 'should send an email if a user has pending invites' do
          FactoryGirl.create(:project_request, requestor: organisation, is_invite: true, responded_to: false)
        ...
        it 'should send an email if a user has pending requests' do
          ...
          FactoryGirl.create(:project_request, is_invite: false, responded_to: false, requestable: pm.project_resource)
        ...
        it 'should not send an email if the requests have been responded to' do
          5.times { FactoryGirl.create(:project_request, requestor: organisation, is_invite: true, responded_to: true) }
